...
export default {
  ...
  methods: {
    addRoom() {
      ...
      let floor = this.registeredRoom.floor
      let totalSeats = this.registeredRoom.totalSeats
          ...
          <form class="p-4 p-md-5 border rounded-3 bg-light">
            ...
            <div class="form-floating mb-3">
              <div class="form-check form-check-inline">
                <input v-model="registeredRoom.floor" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                <label class="form-check-label" for="inlineRadio1">1</label>
              </div>
              <div class="form-check form-check-inline">
                <input v-model="registeredRoom.floor" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
